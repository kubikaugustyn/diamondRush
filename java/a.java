...
public final class a
{
    ...
    public final void a(final byte[] array, int n) {
        try {
            ...
            if ((n2 = (short)((array[n++] & 0xFF) + ((array[n++] & 0xFF) << 8))) > 0) {
                System.arraycopy(array, n, this.a = new byte[n2 << 1], 0, this.a.length);
                n += this.a.length;
            }
            final short n3;
            ...
            if ((n8 = (short)((array[n++] & 0xFF) + ((array[n++] & 0xFF) << 8))) > 0) {
                ...
                for (short n9 = 0; n9 < n8; ++n9) {
                    this.e[n9] = array[n++];
                    ++n;
                    this.b[n9] = (short)((array[n++] & 0xFF) + ((array[n++] & 0xFF) << 8));
                }
            }
            if (n2 <= 0) {
                System.gc();
                ...
                switch (n10) {
                    ...
                    case 17476: {
                        for (int l = 0; l < n11; ++l) {
                            ...
                            this.b[j][l] = ((n13 & 0xF000) << 16 | (n13 & 0xF000) << 12 | (n13 & 0xF00) << 12 | (n13 & 0xF00) << 8 | (n13 & 0xF0) << 8 | (n13 & 0xF0) << 4 | (n13 & 0xF) << 4 | (n13 & 0xF));
                        }
                        break;
                    }
                    case 21781: {
                        for (int n14 = 0; n14 < n11; ++n14) {
                            ...
                            this.b[j][n14] = (n16 | (n15 & 0x7C00) << 9 | (n15 & 0x3E0) << 6 | (n15 & 0x1F) << 3);
                        }
                        break;
                    }
                    case 25861: {
                        for (int n17 = 0; n17 < n11; ++n17) {
                            ...
                            this.b[j][n17] = (n19 | (n18 & 0xF800) << 8 | (n18 & 0x7E0) << 5 | (n18 & 0x1F) << 3);
                        }
                        break;
                    }
                }
    ...
    public final void a(final int b, final int n, int n2, final int n3) {
        ...
        if (this.a[b] == null) {
            this.a[b] = new Image[this.a.length >> 1];
        }
        if (n3 >= 0) {
            for (int i = n; i <= n2; ++i) {
                this.a[b][i] = this.a[n3][i];
            }
        }
        else {
            final int b2 = this.b;
                ...
                if (n5 > 0) {
                    if (n6 > 0) {
                        ...
                        if ((a = this.a(j)) != null) {
                            ...
                            this.a[b][j] = Image.createRGBImage(a, n5, n6, b3);
                        }
                    }
                }
            }
