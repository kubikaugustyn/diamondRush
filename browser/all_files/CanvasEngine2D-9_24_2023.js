...
class CanvasEngine2DImageData {
    ...
    constructor(width, height, data) {
        ...
        if (typeof width !== "number" || width <= 0) throw "CanvasEngine2DImageData width invalid."
        if (typeof height !== "number" || height <= 0) throw "CanvasEngine2DImageData height invalid."
        if (typeof data !== "object" || !(data instanceof Uint32Array) || data.length !== width * height) throw "CanvasEngine2DImageData data invalid."
        this.width = width
        this.height = height
        this.data = data
    }
